...
// import { getServiceBySlug } from "@/lib/services"; // 未使用のためコメントアウト
// import ServiceTemplate from "../[slug]/page"; // 未使用のためコメントアウト
import Image from "next/image";
import { Cpu, Bot, Wand2, Sparkles, Code, Zap, PanelRight } from "lucide-react";

export const metadata: Metadata = {
  title: 'AI開発サービス | Stellarium マーケティング',
  description: 'NotionやDifyを活用したAIアプリケーション開発、カスタムSaaS構築サービス。最新のAI技術で、あなたのビジネスをスマートに自動化します。',
  keywords: ['AI開発', 'Notion', 'Dify', 'SaaS構築', '業務自動化'],
  openGraph: {
    title: 'AI開発サービス | Stellarium マーケティング',
    description: 'NotionやDifyを活用したAIアプリケーション開発。最新のAI技術で、あなたのビジネスをスマートに自動化します。',
    type: 'website',
    locale: 'ja_JP',
    images: [
      {
        url: '/images/og-ai-service.jpg',
        width: 1200,
        height: 630,
        alt: 'AI開発サービス',
      },
  ...
  twitter: {
    ...
    title: 'AI開発サービス | Stellarium マーケティング',
    description: 'NotionやDifyを活用したAIアプリケーション開発。最新のAI技術で、あなたのビジネスをスマートに自動化します。',
    images: ['/images/og-ai-service.jpg'],
  },
  alternates: {
    canonical: 'https://yourdomain.com/services/ai-service'
  }
};
