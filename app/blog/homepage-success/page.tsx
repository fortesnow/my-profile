...
export default function BlogPost() {
  return (
    <article className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <header className="mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <span className="px-3 py-1 text-sm bg-cyan-500/10 text-cyan-400 rounded-full">
                Web制作
              </span>
              <time dateTime="2025-02-21" className="text-gray-400 text-sm">
                2025.02.21
              </time>
            </div>
        ...
        <div className="prose prose-lg prose-invert max-w-none">
          <div className="bg-gradient-to-br from-gray-900/80 via-blue-900/80 to-indigo-900/80 backdrop-blur-md p-8 rounded-lg border border-cyan-500/20">
