...
export const metadata = {
  title: 'LP制作サービス | あおいのプロフィール',
  description: '高品質なランディングページ制作サービスの詳細をご紹介します。',
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white">
      ...
      <div className="fixed bottom-8 right-8">
        <Link 
          href="/"
          className="bg-gray-900/50 backdrop-blur-md p-4 rounded-full text-cyan-400 hover:text-cyan-300 transition-colors duration-300"
        >
